...
public class DownloadImageTask extends AsyncTask<EMMessage, Integer, Bitmap>{
	...
	protected Bitmap doInBackground(EMMessage... params) {
		...
		if (downloadThumbnail) {
		    ...
		    SMTLogUtil.d("###", "localFilePath: "+localFilePath);
		} else {
...
//		final String localFilePath = User.getImagePath() + "/"+ message.getImageName();
		SMTLogUtil.d("###", "download picture from remote "+ remoteFilePath + " to local:" + localFilePath);
		...
		CloudOperationCallback callback = new CloudOperationCallback() {
			public void onSuccess() {
				SMTLogUtil.d("###", "offline file saved to "+ localFilePath);
			...
			public void onError(String msg) {
				SMTLogUtil.e("###","offline file transfer error:" + msg);
	...
	public static String getThumbnailImagePath(String imagePath) {
        ...
        LogUtil.d("msg", "original image path:" + imagePath);
