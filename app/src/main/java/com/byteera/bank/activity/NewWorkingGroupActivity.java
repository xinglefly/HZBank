...
public class NewWorkingGroupActivity extends BaseActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_working_group);
                ...
                @Override public void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            LogUtil.e("NewGroupActivity Exception, %s", e.getMessage());
                        }
                        ...
                        LogUtil.e(e, "New group exception");
                    }
                }
            }).start();
        }
