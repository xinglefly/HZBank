...
import com.byteera.bank.activity.PublicGroupsActivity;
import com.byteera.bank.adapter.GroupAdapter;
		...
		groupListView.setOnItemClickListener(new OnItemClickListener() {
			@Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				if (position == groupAdapter.getCount() - 1) {
					//新建群聊
					startActivityForResult(new Intent(GroupsActivity.this, NewMeetingGroupActivity.class), 0);
				} else {
					//进入群聊
