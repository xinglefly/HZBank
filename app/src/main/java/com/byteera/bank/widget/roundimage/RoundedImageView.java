...
package com.byteera.bank.widget.roundimage;
...
import static com.byteera.bank.widget.roundimage.RoundedDrawable.CORNER_BOTTOM_LEFT;
import static com.byteera.bank.widget.roundimage.RoundedDrawable.CORNER_BOTTOM_RIGHT;
import static com.byteera.bank.widget.roundimage.RoundedDrawable.CORNER_TOP_LEFT;
import static com.byteera.bank.widget.roundimage.RoundedDrawable.CORNER_TOP_RIGHT;
  ...
  private Drawable resolveResource() {
    ...
    if (mResource != 0) {
      try {
        ...
        LogUtil.w("Unable to find resource: " + mResource, e);
        // Don't try again.
        mResource = 0;
      }
    }
