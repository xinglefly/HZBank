...
//              digest = EasyUtils.getAppResourceString(context, "location_prefix");
    ...
    public static void saveImageToGallery(Context context, String localImagePath, String fileName) {
        try
        {
            MediaStore.Images.Media.insertImage(context.getContentResolver(),
                    localImagePath, fileName, null);
        }
        catch (Exception e)
        {
            LogUtil.e(e, "saveImageToGallery Exception");
        }

        // 最后通知图库更新
        context.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE,
                Uri.parse("file://" + localImagePath)));
    }
}
